      ...
      <div className="mb-8" ref={segmentRef}>
        ...
        <div className="relative">
          <div
            ...
            className={`w-full min-h-[42px] pl-10 pr-10 py-2 border-2 rounded-lg cursor-pointer bg-white dark:bg-[#2b2b2b] border-gray-300 dark:border-gray-600 flex flex-wrap gap-2 items-center transition-all duration-200 ${
              isSegmentMenuOpen
